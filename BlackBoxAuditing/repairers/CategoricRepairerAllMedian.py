...
class Repairer(AbstractRepairer):
  def repair(self, data_to_repair):
    ...
    #for i in range(len(data_to_repair)):
      #print(data_to_repair[i][1])

    #for i in range(len(data_to_repair)):
      #print(data_to_repair[i][0])
    ...
    #for group in all_stratified_groups:
      #for col_id, col_dict in list(data_dict.items()):
        ...
        #stratified_col_sorted_values = [val for val, _ in list(indices.items())]
        #stratified_col_sorted_values.sort()
        #stratified_group_sorted_data[group][col_id] = stratified_col_sorted_values
        #stratified_group_data[group][col_id] = stratified_col_values
        #sorted_data_dict[col_id] = sorted_data_dict[col_id]+stratified_col_sorted_values
