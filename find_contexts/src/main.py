...
results_dir = "../output"
output_dir = "{}/{}".format(results_dir, time.time())
...
contexts_of_influence = expand_and_find_contexts(args.original_csv, args.obscured_csv,
						merged_csv, rulesfile, influence_scores, obscured_tag, output_dir)
