...
def setup_and_call_repair(quickname, filepath, repair_directory, identifier_col_names, protected_col_names, 
    ...
    orig_file.seek(0)
    file_reader.next()
    with open(repair_dir+"Fixed_Data.csv", 'wb') as fixed_data:
    ...
    return repair_dir+"Fixed_Data.csv"
...
def repair_script_test():
    ...
    filepath = "RicciDataMod.csv"
    repair_directory =  "test_data"
	...
	correct_data = "kav_repaired_ricci.csv"
